...
function ContactUs() {
  return (
    <div className="w-full h-96 bg-[url('https://plus.unsplash.com/premium_photo-1661573644696-d670a189244b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTN8fGN1c3RvbWVyJTIwc2VydmljZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60')] bg-no-repeat bg-top bg-cover relative flex items-center justify-center">
