...
function ClientsAndSponsor() {
  ...
  return (
    <div className="w-full h-fit py-16 md:px-14 lg:px-28 flex flex-col items-center gap-12 bg-gray-100">
      {/* Top Content */}
      <div className="w-full h-full flex md:flex-col lg:flex-row md:gap-12 lg:gap-40 items-center ">
        {/* Left Content */}
        <div className="w-3/4 lg:w-1/2 flex flex-col gap-3 md:items-center lg:items-start">
        ...
        {/* Right Content */}
        <div className="w-3/4 lg:w-1/2 h-[340px] bg-[url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTN8fGJ1c3NpbmVzcyUyMHRlYW18ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60')] bg-no-repeat bg-center bg-cover shadow-md rounded-sm relative">
          <div className="max-w-md p-8 border-l-4 border-green-500 italic text-gray-500 text-sm bg-white rounded-sm shadow-lg absolute left-10 lg:-left-16 -bottom-16">
