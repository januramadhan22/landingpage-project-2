...
function AboutUs() {
  return (
    <div className="w-full md:p-6 lg:p-20 bg-gray-100">
      <div className="w-full flex flex-col lg:flex-row justify-center md:items-center lg:items-end gap-8">
        {/* Left Content */}
        <div className="md:2-full lg:w-1/2 flex flex-col gap-10 items-center">
          <img
            ...
            alt=""
            className="max-w-md rounded md:-mt-16 lg:-mt-32 shadow-md"
          />
        ...
        {/* Right Content */}
        <div className="md:w-full lg:w-1/2 flex flex-col items-center gap-3 md:text-center lg:text-left">
          <h3 className=" text-green-500 font-bold text-xl">About Us</h3>
          <h1 className="md:w-10/12 lg:max-w-md text-5xl font-bold">
            Discover The World of Financial Planner
          </h1>
          <p className="md:w-9/12 lg:max-w-md">
